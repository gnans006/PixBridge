...
namespace EventPhoto.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260820172457_AddExtendedTrialAndHasUsedTrialExtension")]
    partial class AddExtendedTrialAndHasUsedTrialExtension
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventPhoto.Domain.Entities.ApplicationSettings", b =>
                {
                    ...
                    b.Property<string>("GalleryTheme")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(30)
            ...
            modelBuilder.Entity("EventPhoto.Domain.Entities.GuestUpload", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("EventId", "ModerationStatus")
                        .HasDatabaseName("IX_guest_uploads_event_moderation");

                    b.ToTable("guest_uploads", (string)null);
                });

            modelBuilder.Entity("EventPhoto.Domain.Entities.GuestUploadSession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("EventPhoto.Domain.Entities.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<int>("MaxUsersPerStudio")
                        .HasColumnType("integer")
                        .HasColumnName("max_users_per_studio");
            ...
            modelBuilder.Entity("EventPhoto.Domain.Entities.GuestUpload", b =>
                {
                    ...
                    b.HasOne("EventPhoto.Domain.Entities.GuestUploadSession", null)
                        .WithMany()
